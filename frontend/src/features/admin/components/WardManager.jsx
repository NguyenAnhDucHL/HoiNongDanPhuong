...
export default function WardManager() {
  ...
  const paginatedWards = wards.slice((page - 1) * ITEMS_PER_PAGE, page * ITEMS_PER_PAGE);

  return (
    <div>
      <h3 className="text-[#087c20] font-extrabold mb-[20px] text-[18px]">Quản lý Khu phố Phản ánh</h3>
          ...
          <table className="w-full border-collapse text-left text-[14px]">
            <thead>
              <tr>
                ...
                <th className="px-[16px] py-[12px] bg-[#f8fafc] text-[#718096] font-semibold text-[12px] uppercase tracking-[0.05em] border-b border-[#e2e8f0]">Tên khu phố</th>
      ...
      <ConfirmModal
        isOpen={!!deleteId}
        title="Xác nhận xóa"
        message="Bạn có chắc chắn muốn xóa khu phố này không? Hành động này không thể hoàn tác."
